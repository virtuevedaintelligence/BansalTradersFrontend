    ...
    <div>
      <div className="p-5">
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            <MDBInput wrapperClassName="mb-4" label="First Name" name="firstName" id="firstName" type="text" value={values.firstName}
              onChange={handleChange} onBlur={handleBlur} />
            {errors.firstName && touched.firstName ? <p className="form-error">{errors.firstName}</p> : null}
          </div>
          <div className="mb-3">
            <MDBInput wrapperClassName="mb-4" label="Last Name" name="lastName" id="lastName" type="text" value={values.lastName}
              onChange={handleChange} onBlur={handleBlur} />
            {errors.lastName && touched.lastName ? <p className="form-error">{errors.lastName}</p> : null}
          </div>
          <div className="mb-3">
            <MDBInput wrapperClassName="mb-4" label="Email" name="email" id="email" type="email" value={values.email}
              onChange={handleChange} onBlur={handleBlur} />
            {errors.email && touched.email ? <p className="form-error">{errors.email}</p> : null}
          </div>
          <div className="mb-3">
            <MDBInput wrapperClassName="mb-4" label="Contact Number" name="contactNumber" id="contactNumber" type="text"
          ...
          <div className="mb-3">
            <MDBInput wrapperClassName="mb-4" label="Password" name="password" id="password" type="password"
              value={values.password} onChange={handleChange} onBlur={handleBlur} />
            {errors.password && touched.password ? <p className="form-error">{errors.password}</p> : null}
          </div>
          <div className="mb-3">
            <MDBInput wrapperClassName="mb-4" label="Confirm Password" name="confirmpassword" id="confirmpassword" type="password"
