          ...
          <div className="faq-list">
            <ul>
              <li data-aos="fade-up" className="aos-init aos-animate">
                ...
                <div id="faq-list-1" className="collapse" data-bs-parent=".faq-list" style="">
              ...
              <li data-aos="fade-up" data-aos-delay="100" className="aos-init aos-animate">
                {" "}
                <i className="bx bx-help-circle icon-help"></i>{" "}
                <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" className="collapsed" aria-expanded="false">
                  Feugiat scelerisque varius morbi enim nunc? <i className="bx bx-chevron-down icon-show"></i>
                  <i className="bx bx-chevron-up icon-close"></i>
                </a>
                <div id="faq-list-2" className="collapse" data-bs-parent=".faq-list" style="">
              ...
              <li data-aos="fade-up" data-aos-delay="200" className="aos-init aos-animate">
                {" "}
                <i className="bx bx-help-circle icon-help"></i>{" "}
                <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" className="" aria-expanded="true">
                  Dolor sit amet consectetur adipiscing elit? <i className="bx bx-chevron-down icon-show"></i>
                  <i className="bx bx-chevron-up icon-close"></i>
                </a>
                <div id="faq-list-3" className="collapse show" data-bs-parent=".faq-list" style="">
              ...
              <li data-aos="fade-up" data-aos-delay="300" className="aos-init aos-animate">
                {" "}
                <i className="bx bx-help-circle icon-help"></i>{" "}
                <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" className="collapsed" aria-expanded="false">
              ...
              <li data-aos="fade-up" data-aos-delay="400" className="aos-init aos-animate">
                {" "}
                <i className="bx bx-help-circle icon-help"></i>{" "}
                <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" className="collapsed" aria-expanded="false">
